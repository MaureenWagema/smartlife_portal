SmartLife.group_forgot = function (params) {
    "use strict";
    ...
    var viewModel = {
        ...
        doAgentVerify: function () {
            ...
            let data = formForgotPassInstance.option("formData");
            console.log(data);
            get_life.DBpost("auth/SendGroupOTP", data).done(function (result) {
                viewModel.LoadPanelShown(false);

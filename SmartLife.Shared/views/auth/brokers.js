SmartLife.brokers = function (params) {
    "use strict";
    ...
    var viewModel = {
        ...
        viewShown: function () {
            ...
            table.find('p').click(function () {
                viewModel.navigateForward("broker_register", "");
            });
        },
        ...
        doLogin: function () {
            ...
            console.log(data);
            get_life.DBpost("auth/BrokerLogin", data).done(function (result) {
                viewModel.LoadPanelShown(false);
                if (result.success == true) {
                    ...
                    SmartLife.pos_name = '';
                    SmartLife.channel = 0;
                    SmartLife.login_type = 5;//broker
                    SmartLife.pos_type = '';//result.pos_type;
                    //brokers
                    SmartLife.broker_id = result.broker_id;
                    SmartLife.broker_name = result.broker_name;
                    SmartLife.member_no = '';
                    ...
                    save_roles.save_login(function (status) {
                        if (status) {
                            SmartLife.app.navigate('broker_home', { root: true });
                        }
                    });
                } else {

SmartLife.AgentPerformance = function (params) {
    //"use strict";
    var formSearchDetailsInstance;
    var params_url = "reports/getAgentPerformance?";
    var lblTotalCompleteSales = "Total Sales: ";
    var lblTotalLifeSales = "Total Life Sales: ";
    var lblTotalMicroSales = "Total Micro Sales: ";
    var completeAmount = 0;
    var completeLifeAmount = 0;
    var completeMicroAmount = 0;
    ...
    var viewModel = {
        ...
        complete_total: ko.observable(lblTotalCompleteSales + completeAmount),
        complete_life_total: ko.observable(lblTotalLifeSales + completeLifeAmount),
        complete_micro_total: ko.observable(lblTotalMicroSales + completeMicroAmount),
        get_analysis: function () {
            ...
            get_form.DBget(params_url).done(function (result) {
                ...
                if (result.success == true) {
                    viewModel.analysis_store(result.MicroAgents);
                    viewModel.life_analysis_store(result.LifeAgents);

                    
                    completeLifeAmount = result.MicroTotals[0].totals;
                    viewModel.complete_micro_total(lblTotalLifeSales + completeLifeAmount.toString());
                    completeMicroAmount = result.LifeTotals[0].totals;
                    viewModel.complete_life_total(lblTotalLifeSales + completeMicroAmount.toString());

                    
                    completeAmount = parseInt(completeLifeAmount) + parseInt(completeMicroAmount);
                    viewModel.complete_total(lblTotalCompleteSales + completeAmount.toString());
                } else {
                        ...
                        buttonOptions: {
                            ...
                            onClick: function (args) {
                                ...
                                if (result.isValid) {
                                    ...
                                    params_url = "reports/getAgentPerformance?agent_no=" + SmartLife.agent_no +

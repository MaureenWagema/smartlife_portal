var Access = (function (window, $Access) {
    ...
    function get_default_roles() {
        ...
        SmartLife.config.navigation[5].visible(false);//claim enquiry
        ...
        SmartLife.config.navigation[19].visible(false);
        SmartLife.config.navigation[20].visible(false);
        SmartLife.config.navigation[21].visible(false);
        SmartLife.config.navigation[22].visible(false);
        SmartLife.config.navigation[23].visible(false);
        SmartLife.config.navigation[24].visible(false);
        SmartLife.config.navigation[25].visible(false);
        SmartLife.config.navigation[26].visible(false);
        SmartLife.config.navigation[27].visible(false);
        SmartLife.config.navigation[28].visible(false);
        SmartLife.config.navigation[29].visible(false);
    }
    ...
    function get_access_roles(fn) {
        ...
        if (SmartLife.login_type == 2) {
            ...
            SmartLife.config.navigation[5].visible(true);//claim enquiry
            ...
            SmartLife.config.navigation[20].visible(true);
            SmartLife.config.navigation[25].visible(true);
            SmartLife.config.navigation[28].visible(true);
            if (SmartLife.channel == 5) {//micro
                SmartLife.config.navigation[27].visible(true);
            }
            if (SmartLife.channel == 4) {//bancassurance
                SmartLife.config.navigation[4].visible(true);//enquiry
                SmartLife.config.navigation[17].visible(false);
                SmartLife.config.navigation[20].visible(false);
            }
            if (SmartLife.agent_position_id == '8') {
                ...
                SmartLife.config.navigation[26].visible(true);
            }
            if (SmartLife.agent_position_id == '4' || SmartLife.agent_position_id == '6' || SmartLife.agent_position_id == '7') {
                SmartLife.config.navigation[26].visible(true);
            }
            /*if (SmartLife.agent_position_id == '8') {
                SmartLife.config.navigation[26].visible(true);
                SmartLife.config.navigation[27].visible(true);
                SmartLife.config.navigation[28].visible(true);
                SmartLife.config.navigation[29].visible(true);
            }*/
        }
        //pos
        ...
        if (SmartLife.login_type == 4) {
            SmartLife.config.navigation[21].visible(true);
            //SmartLife.config.navigation[17].visible(true);
            SmartLife.config.navigation[24].visible(true);
            SmartLife.config.navigation[29].visible(true);
        }
        //broker
        if (SmartLife.login_type == 5) {
            //SmartLife.config.navigation[16].visible(true);
            SmartLife.config.navigation[22].visible(true);
            SmartLife.config.navigation[23].visible(true);
        }
    ...
    function save_login(fn) {
        logged_user.byKey(1).done(function (dataItem) {
            ...
            logged_user.update(1, {
                ...
                agent_position: SmartLife.agent_position,
                agent_office: SmartLife.agent_office,
                agent_position_id: SmartLife.agent_position_id,
                IsManager: SmartLife.IsManager,
                pos: SmartLife.pos,
                ...
                IsCreditLifeUser: SmartLife.IsCreditLifeUser

...
var Policy_det = (function (window, $Policy_det) {
    ...
    Policy_detPrototype.get_hci = get_hci;
    ...
    function get_lgp() {
        var lgp_content = `<p>The <strong>FAMILY LIFE COMPREHENSIVE INSURANCE PLAN</strong> guarantees a minimum lump sum for policyholders and their families in case of death, permanent disability, or critical illness, ensuring that beneficiaries receive financial support upon the death of the policyholder or spouse.</p>
            <p>The Family Life Comprehensive Insurance Plan is designed to provide financial sustenance to families, offering a lump sum for family upkeep should the policyholder pass away.</p>
            <p>This policy covers the policyholder and two spouses.</p>
            <p><strong>What are the benefits of this insurance plan?</strong></p>
            <ul>
                <li>Premium refund</li>
                <li>Death benefit</li>
                <li>Total Permanent Disability coverage</li>
                <li>Critical Illness benefit</li>
                <li>Family Upkeep benefit</li>
                <li>Free Medical Check-Up & Lifestyle Medical Consultancy</li>
                <li>Premium Holiday</li>
                <li>No Lapse feature</li>
            </ul>
            `;
        return lgp_content;
    }
    ...
    function get_hci() {
        var lgp_content = `<p><strong>This policy is a living benefit</strong> designed to cater for the income lost and the incidental costs incurred as a result of the hospitalization of a family member.</p>
            <p>The plan pays daily benefits for each day an insured life is admitted to the hospital. It aims to replace the daily income lost by family members during the hospitalization period and helps cover incidental costs such as traveling, communication, and other related expenses.</p>

            <p><strong>Characteristics of the Product</strong></p>
            <ul>
                <li>This policy covers the policyholder, with the option to add on family members:</li>
                <ul>
                    <li>Spouse – Maximum of two (2)</li>
                    <li>Children – Unlimited</li>
                    <li>Parents and Parents-in-law – Maximum of four (4)</li>
                </ul>
                <li>The minimum duration of the policy is ten (10) years, and the policy terminates at age 65.</li>
            </ul>

            <p><strong>Entry Age:</strong></p>
            <ul>
                <li>Policyholder and Spouse – 18 to 55 years</li>
                <li>Parents and Parents-in-law – 35 to 70 years</li>
                <li>Children – 0 to 24 years (covered under the policy until the attainment of age 30)</li>
            </ul>
            `;
        return lgp_content;
    }

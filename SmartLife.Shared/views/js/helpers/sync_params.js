var Sync = (function (window, $Sync) {
    ...
    function sync_parameters(fn) {
        ...
        syncParams().done(function (result) {
            ...
            SmartLife.AgentsPaymethodInfo = result.AgentsPaymethodInfo;
            SmartLife.PyPayrollCategory = result.PyPayrollCategory;
            SmartLife.POSComplaintType = result.POSComplaintType;
            /////////////Confirmations/////////////
            ...
            SmartLife.Activities = [
                { id: 1, description: "Claims", showInPortal: 0 },
                { id: 2, description: "Endorsement", showInPortal: 0 },
                { id: 3, description: "General Enquiry", showInPortal: 1 },
                { id: 4, description: "Client Complaints", showInPortal: 1 }
            ]

SmartLife.claims_list = function (params) {
    //"use strict";
    var formSearchDetailsInstance;
    var params_url = "claims/getClientClaims?is_micro=0&is_dashboard=1";
        ...
        get_analysis: function () {
            ...
            get_form.DBget(params_url).done(function (result) {
                ...
                if (result.success == true) {
                    viewModel.analysis_store(result.Claims);
                } else {

SmartLife.underwriting = function (params) {
    "use strict";
    var params_url = "reports/getUnderwritingTotals";
    ...
    var viewModel = {
                        ...
                        buttonOptions: {
                            ...
                            onClick: function (args) {
                                ...
                                if (result.isValid) {
                                    ...
                                    params_url = "reports/getUnderwritingTotals?date_from=" + viewModel.formatDate(new Date(data['date_from'])) +
        ...
        get_totals: function () {
            ...
            get_life.DBget(params_url).done(function (result) {
                viewModel.LoadPanelShown(false);
                if (result.success == true) {
                    viewModel.lblReceivedILProposals(result.lblReceivedILProposals);
                    viewModel.lblAppraisedILPolicies(result.lblAppraisedILPolicies);
                    viewModel.lblMicroProposals(result.lblMicroProposals);
                    viewModel.lblAppraisedMicroPolicies(result.lblAppraisedMicroPolicies);
                } else {
                    viewModel.show_test(result.msg, 'error');
                }
            }).fail(function () {
        ...
        lblReceivedILProposals: ko.observable(0),
        lblAppraisedILPolicies: ko.observable(0),
        lblMicroProposals: ko.observable(0),
        lblAppraisedMicroPolicies: ko.observable(0),

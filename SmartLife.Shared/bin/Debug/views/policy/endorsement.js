                            ...
                            editorOptions: {
                                ...
                                onValueChanged: function (e) {
                                    if (e.value == '2') {
                                        ...
                                        formEndorsementSubmitInstance.updateData("EFTBank_codeOLD", viewModel.policy_obj()['bank_name']);
                                        formEndorsementSubmitInstance.updateData("EFTBankBranchCodeOLD", viewModel.policy_obj()['bank_branch']);
                            ...
                            },
                            {
                                ...
                                cellTemplate: function (container, options) {
                                    $("<div />").appendTo(container).dxButton({
                                        ...
                                        onClick: function () {
                                            //display the file
                                            window.open(options.data.filepath, '_blank', 'hidden=no', 'location=no');
                                        },
                                        width: 120
                                    }).appendTo(container);
                                }
